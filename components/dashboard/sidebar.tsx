...
export function DashboardSidebar() {
  ...
  return (
    <aside className="w-64 border-r border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 flex flex-col shrink-0 h-screen sticky top-0">
      {/* Brand Header */}
      ...
      <div className="p-3 border-t border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center gap-3 p-2 rounded-xl bg-neutral-50 dark:bg-neutral-800/60">
