...
export function TemplateHero({
  ...
  return (
    <section className="py-12 sm:py-16 border-b border-neutral-100 dark:border-neutral-800/80 bg-white dark:bg-neutral-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-4">
        ...
        <p className="text-xs sm:text-sm text-neutral-500 max-w-xl mx-auto line-clamp-3 leading-relaxed">
          {heroSubtitle}
        </p>
      </div>
    </section>
