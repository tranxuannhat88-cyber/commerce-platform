...
export function TemplateEngine({
  ...
  return (
    <div className={`min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 ${template.design_tokens.font_family}`}>
      {/* 1. HERO SECTION */}
      ...
      <div className={`${containerWidthClass} mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12`}>
        {/* 2. TRUST BAR (Top placement for Professional, Modern, Corporate Pro) */}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl sm:text-2xl font-black tracking-tight text-neutral-900 dark:text-neutral-100">
                  {template.code === "FREE_SERVICE" ? "Dịch Vụ Cung Cấp" : "Sản Phẩm Cửa Hàng"}
                </h2>
